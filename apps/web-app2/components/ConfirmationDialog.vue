  ...
  <Modal :id="id" @closeModal="handleCloseModal">
    <div
      ...
      <div class="flex items-center justify-between mb-8">
        ...
        <button @click="handleCloseModal" class="text-text-secondary hover:text-text-primary-hover">
      ...
      <div class="min-w-[15.625rem] max-w-[21.875rem] text-text-secondary">
        ...
        <div class="flex justify-end gap-2">
          ...
          <Button @click="handleCloseModal" variant="secondary">No</Button>
        </div>
      </div>
    </div>
  </Modal>
...
const handleCloseModal = () => {
  closeModal();
  router.push({ name: 'previousRouteName' }); // Adjust this to your actual route name
};
