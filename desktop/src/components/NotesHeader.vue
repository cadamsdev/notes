...
<template>
  <header class="bg-surface border border-border rounded-2xl mb-6">
    <div class="px-8 py-6">
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            ...
            class="w-9 h-9 rounded-lg hover:bg-surface transition-colors flex items-center justify-center text-text-secondary hover:text-text-primary"
            title="Settings"
          >
